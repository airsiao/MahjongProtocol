package com.ourgame.mahjong.message.chat {
	...
	import com.ourgame.mahjong.message.chat.OGAckChatMsg.ErrorType;
	...
	public dynamic final class OGAckChatMsg extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const RESULT:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.ourgame.mahjong.message.chat.OGAckChatMsg.Result", "result", (1 << 3) | com.netease.protobuf.WireType.VARINT, com.ourgame.mahjong.message.chat.ChatResult);
		 ...
		 *  @private
		 */
		public static const REASON:FieldDescriptor$TYPE_ENUM = new FieldDescriptor$TYPE_ENUM("com.ourgame.mahjong.message.chat.OGAckChatMsg.Reason", "reason", (2 << 3) | com.netease.protobuf.WireType.VARINT, com.ourgame.mahjong.message.chat.OGAckChatMsg.ErrorType);
		...
		public function get reason():int {
			if(!hasReason) {
				return com.ourgame.mahjong.message.chat.OGAckChatMsg.ErrorType.ET_UNKNOWN;
			}
			return Reason$field;
		}
		 ...
		 *  @private
		 */
		public static const FAILEDCOUNT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.ourgame.mahjong.message.chat.OGAckChatMsg.FailedCount", "failedCount", (3 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const REQ:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.ourgame.mahjong.message.chat.OGAckChatMsg.Req", "req", (4 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return com.ourgame.mahjong.message.chat.OGReqChatMsg; });
