package com.ourgame.mahjong.bloodriver.message.NtfGameOver {
	...
	public dynamic final class FinalStatus extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const SEAT:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.ourgame.mahjong.bloodriver.message.NtfGameOver.FinalStatus.seat", "seat", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const TILESINHAND:RepeatedFieldDescriptor$TYPE_UINT32 = new RepeatedFieldDescriptor$TYPE_UINT32("com.ourgame.mahjong.bloodriver.message.NtfGameOver.FinalStatus.tilesInHand", "tilesInHand", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const STATUS:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("com.ourgame.mahjong.bloodriver.message.NtfGameOver.FinalStatus.status", "status", (3 << 3) | com.netease.protobuf.WireType.VARINT);
