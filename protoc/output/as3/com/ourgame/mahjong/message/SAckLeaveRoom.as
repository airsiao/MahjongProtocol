package com.ourgame.mahjong.message {
	...
	public dynamic final class SAckLeaveRoom extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const RESULT:FieldDescriptor$TYPE_INT32 = new FieldDescriptor$TYPE_INT32("com.ourgame.mahjong.message.SAckLeaveRoom.result", "result", (2 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const FAILREASON:FieldDescriptor$TYPE_STRING = new FieldDescriptor$TYPE_STRING("com.ourgame.mahjong.message.SAckLeaveRoom.failReason", "failReason", (3 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED);
